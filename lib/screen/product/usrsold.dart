...
class UsrSold extends StatefulWidget {
  final String id;
  UsrSold({required this.id});

  @override
  State<UsrSold> createState() => _UsrSoldState();
}

class _UsrSoldState extends State<UsrSold> {
  Future getSold(String url) async {
    var response = await http.get(Uri.parse(
        url+'api/product/sold/id/' + widget.id));
